...
""".trimIndent()
    ...
    fun initialize(context: Context): File {
        ...
        if (!bashrc.exists() || currentVersion < BASHRC_VERSION) {
            ...
            sb.appendLine("    if [ -n \"\$__cd_alias\" ]; then")
            sb.appendLine("      set -- --add-dir \"\$__cd_alias\" \"\$@\"")
            sb.appendLine("    fi")
            sb.appendLine("  else")
            sb.appendLine("    __cd_target=\"\$(pwd)\"")
            sb.appendLine("    __cd_alias=\"\$(__shelly_codex_alias_for \"\$__cd_target\")\"")
            sb.appendLine("    if [ -n \"\$__cd_alias\" ]; then")
            sb.appendLine("      set -- -C \"\$__cd_target\" --add-dir \"\$__cd_alias\" \"\$@\"")
            sb.appendLine("    else")
            sb.appendLine("      set -- -C \"\$__cd_target\" \"\$@\"")
            sb.appendLine("    fi")
            sb.appendLine("  fi")
            ...
            sb.appendLine("          local __cwd=\"\$(pwd)\"")
            sb.appendLine("          local __cwd_alias=''")
            sb.appendLine("          case \"\$__cwd\" in")
            sb.appendLine("            /data/user/0/*) __cwd_alias=\"/data/data/\${__cwd#/data/user/0/}\" ;;")
            sb.appendLine("            /data/data/*) __cwd_alias=\"/data/user/0/\${__cwd#/data/data/}\" ;;")
            sb.appendLine("          esac")
            sb.appendLine("          if [ -n \"\$__cwd_alias\" ]; then")
            sb.appendLine("            __exec_args=(-C \"\$__cwd\" --add-dir \"\$__cwd_alias\" \"\${__exec_args[@]}\")")
            sb.appendLine("          else")
            sb.appendLine("            __exec_args=(-C \"\$__cwd\" \"\${__exec_args[@]}\")")
            sb.appendLine("          fi")
            sb.appendLine("        else")
            sb.appendLine("          local __cd_alias=''")
            sb.appendLine("          case \"\$__cd_target\" in")
            sb.appendLine("            /data/user/0/*) __cd_alias=\"/data/data/\${__cd_target#/data/user/0/}\" ;;")
            sb.appendLine("            /data/data/*) __cd_alias=\"/data/user/0/\${__cd_target#/data/data/}\" ;;")
            sb.appendLine("          esac")
            sb.appendLine("          [ -n \"\$__cd_alias\" ] && __exec_args=(--add-dir \"\$__cd_alias\" \"\${__exec_args[@]}\")")
            sb.appendLine("        fi")
            sb.appendLine("        __shelly_paste_tui_begin")
            sb.appendLine("        SHELLY_LIB_DIR=\"$libDir\" SHELLY_CODEX_EXEC_PATH=\"\$__chosen_exec\" SHELLY_CODEX_PROC_EXE_SHIM=1 SHELLY_CODEX_PROC_EXE_OPEN_SHIM=1 LD_PRELOAD=\"$libDir/libexec_wrapper.so\" _run \"\$__chosen_exec\" \"\${__exec_args[@]}\"")
            ...
            sb.appendLine("    __shelly_paste_tui_begin")
            sb.appendLine("    SHELLY_LIB_DIR=\"$libDir\" SHELLY_CODEX_EXEC_PATH=\"\$__chosen_tui\" SHELLY_CODEX_PROC_EXE_SHIM=1 SHELLY_CODEX_PROC_EXE_OPEN_SHIM=1 LD_PRELOAD=\"$libDir/libexec_wrapper.so\" _run \"\$__chosen_tui\" \"\$@\"")
            ...
            sb.appendLine("    __out=\$(cd \"\$__work\" && HOME=\"\$HOME\" CODEX_HOME=\"\${CODEX_HOME:-\$HOME/.codex}\" TERM=\"\${TERM:-xterm-256color}\" TMPDIR=\"\${TMPDIR:-\$HOME/.tmp}\" PATH=\"\$HOME/bin:$libDir:\${PATH:-/system/bin:/vendor/bin}\" timeout 240 /system/bin/env SHELLY_CODEX_EXEC_PATH=\"\$__chosen_exec\" SHELLY_CODEX_PROC_EXE_SHIM=1 SHELLY_CODEX_PROC_EXE_OPEN_SHIM=1 LD_PRELOAD=\"$libDir/libexec_wrapper.so\" LD_LIBRARY_PATH=\"\$SHELLY_LD_LIBRARY_PATH\" /system/bin/linker64 \"\$__chosen_exec\" -C \"\$__work\" --add-dir \"\$__work_alias\" \"\$__prompt\" 2>&1)")
            sb.appendLine("    __rc=\$?")
            sb.appendLine("    printf '%s\\n' \"\$__out\" | sed -n '1,220p'")
