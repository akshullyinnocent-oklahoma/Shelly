...
""".trimIndent()
    ...
    private const val BASHRC_VERSION = 223
    ...
    fun initialize(context: Context): File {
        ...
        if (!bashrc.exists() || currentVersion < BASHRC_VERSION) {
            ...
            sb.appendLine("    if [ \"\$__rc\" = \"135\" ]; then")
            sb.appendLine("      __shelly_codex_mark_tui_failed \"\$__primary\"")
            sb.appendLine("      echo '[shelly] Codex app-data runtime exited during startup; retrying bundled runtime.' >&2")
